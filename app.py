...
if st.button("Predict"):
    ...
    st.write(f"- Heart Failure: {'Yes' if predicted_class[0][0] == 0 else 'No'} (Probability: {predicted_proba[0][0]:.2f})")
    st.write(f"- Myocardial Infarction: {'Yes' if predicted_class[0][1] == 1 else 'No'} (Probability: {predicted_proba[0][1]:.2f})")
    st.write(f"- Stroke: {'Yes' if predicted_class[0][2] == 2 else 'No'} (Probability: {predicted_proba[0][2]:.2f})")
    st.write(f"- Death: {'Yes' if predicted_class[0][3] == 3 else 'No'} (Probability: {predicted_proba[0][3]:.2f})")
